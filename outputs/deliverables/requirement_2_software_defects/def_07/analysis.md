# DEF-07 - SWE-bench: Can Language Models Resolve Real-world Github Issues?
...
|---|---|
| Defect ID | DEF-07 |
| Paper ID | conf/iclr/JimenezYWYPPN24 |
| Publicized Year | 2024 |
| Venue | ICLR |
| Product/System | Real-world GitHub issue resolution benchmark |
| Domain | General |
...
| Source Link | https://arxiv.org/abs/2310.06770 |
| Artifact Link(s) | https://github.com/swe-bench/SWE-bench |
| Evidence Screenshot | Screenshot 2026-06-01 100009.png |

---

## 2. Defect Description

This analysis concerns "SWE-bench: Can Language Models Resolve Real-world Github Issues?", a 2024 software-defect study or dataset related to Real-world GitHub issue resolution benchmark in the General domain. The available metadata classifies the record as Functional / AI-LLM and points to source evidence through Issue Reports, the paper link, and artifact link(s). No specific GitHub issue link is available in the metadata, so the analysis remains at paper or dataset level. The current evidence supports a dataset-level description rather than a fully confirmed single-defect narrative.
...
The AI summarized likely consequences correctly in general, but the exact affected workflow was not verified in the source evidence.
