# DEF-04 - A Comprehensive Study of Real-World Bugs in Machine Learning Model Optimization.
...
|---|---|
| Defect ID | DEF-04 |
| Paper ID | conf/icse/GuanXLLB23 |
| Publicized Year | 2023 |
| Venue | ICSE |
| Product/System | Machine learning model optimization systems |
...
Reason:
The selected severity is High because the metadata combines functional and performance risk in Machine learning model optimization systems, which can affect correctness and operational reliability. This is a report-level assessment based on available metadata, not a severity value explicitly confirmed by the source.
...
The AI attempted to estimate operational impact from metadata categories alone, which may overstate the actual defect severity.
